...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <a style="text-decoration:none" href="<?= base_url() . 'barang' ?>">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a style="text-decoration:none" href="<?= base_url() . 'transaksi' ?>">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a style="text-decoration:none" href="<?= base_url() . 'pemesanan' ?>">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <a style="text-decoration:none" href="<?= base_url() . 'pegawai' ?>">

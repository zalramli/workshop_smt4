<!-- <div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h 3 mb-0 text-gray-800">Jabatan</h1>
			...
			<form class="" method="post" action="<?php echo base_url() . 'Jabatan/update'; ?>">
				<div class="form-group row">
					<div class="col-sm-6 mb-3 mb-sm-0">
						<label for="exampleInputEmail">ID Jabatan</label>
						<input type="text" name="id_jabatan" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan ID" value="<?= $item->id_jabatan ?>" readonly>
					</div>
					<div class="col-sm-6 mb-3 mb-sm-0">
						<label for="exampleInputEmail">Nama Jabatan</label>

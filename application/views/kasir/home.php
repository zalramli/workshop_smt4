                        ...
                        ?>
                            <tr>
                                ...
                                if ($grand_total == 0) {
                                    ...
                                    echo "<td>" . number_format($grand_total, 0, ",", "."); ?>."</td>";
                                    }
                                    ?>
                                    <td align="right" colspan="3"><?php echo number_format($grand_total, 0, ",", "."); ?></td>
                                </tr>
                                </table>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        if ($grand_total == 0) {
                                            ...
                                            echo "<h6 style='text-align:right;margin-right:12px;'>" . "Rp. " . $totals . "</h6>";
                                        }
                                        ?>
